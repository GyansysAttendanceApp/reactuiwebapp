...
//         // New structure: Aggregate by DeptID and DeptName
//         const aggregated = rawData.reduce((acc, item) => {
//           const key = `${item.DeptID}-${item.DeptName}`;
//           if (!acc[key]) {
//             acc[key] = {
//               DeptID: item.DeptID,
...
//             };
//           }
//           acc[key].totalcount += parseInt(item.TotalCount || 0);
//           acc[key].TodaysCount += parseInt(item.TodaysCount || 0);
//           return acc;
//         }, {});
...
//         <Grid container spacing={1.5}>
//           <Grid item xs={12} sm={6}>
//             <TableContainer component={Paper} sx={{ maxHeight: '76.5vh', overflow: 'none' }}>
//               <Table>
//                 <TableHead>
//                   <TableRow>
//                     <TableCell>
